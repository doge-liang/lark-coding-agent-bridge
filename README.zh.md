...
Codex profile 的 owner/admin 也可以在飞书里发送 `/codex-config`，或通过悬浮菜单项 `Codex 设置` 打开表单卡片，修改 `workspaces.default`、canonical permissions、Codex home 模式、`ignoreUserConfig` 和 `ignoreRules`。
